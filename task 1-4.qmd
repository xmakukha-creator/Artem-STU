...
# Call the function
my_data <- load_and_inspect("C:/Users/makuh/OneDrive/Рабочий стол/ua.csv")
```
...
# Example calls
find_avg_population(my_data, "Kyiv City")
find_avg_population(my_data, "Lvivska Oblast")
```
...
# Example calls
generate_report(my_data, "Kyiv City")
generate_report(my_data, "Odeska Oblast")
```
